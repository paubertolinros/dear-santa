module.exports = [
  ...
  },
  {
    ...
    recipient: 'Carla',
    season: 'birthday',
    description: "Fast, Fancy, and Functional. The Feather is an all-purpose single-speed commuter or urban utility bike that might just be the most fun bike you've ever ridden. A flip-flop hub puts a fixed gear cog on one side and a freewheel on the other so you can choose your riding style."
  },
  {
    name: 'Lettering Kit',
    image: '/images/lettering.jpeg',
    price: 15,
    recipient: 'Carla',
    season: 'invisible friend',
  ...
  },
  {
    ...
    recipient: 'Pere',
    season: 'christmas',
    description: 'Designed with style in mind, the acrylic Backgammon Cocktail Tray is perfect for entertaining. Made from transparent acrylic and complete with white, transparent and sepia-toned playing pieces, this modern 2-in-1 drinks tray includes everything you need for an afternoon game of backgammon by the pool. Bring a sophisticated edge to your next pool party or sunset sipping session with this classic game set reimagined.'
  },
]